...
const ScheduleCard = ({data, is_class, timetables}: Props) => {
    if(data.type === 'holiday') {
        return (<div className="flex flex-col overflow-hidden h-full w-[480px] max-w-[calc(100vw-calc(var(--size-2xs)*2))] px-[calc(var(--size-2xs)*1.2)] pt-[calc(var(--size-2xs)*0.9)] light:border-neutral-5 dark:border-neutral-1 border-solid border-2 rounded-(--size-m) transition-colors ease-custom duration-300">
        ...
        return (
            <div className="flex flex-col overflow-hidden h-full w-[480px] max-w-[calc(100vw-calc(var(--size-2xs)*2))] px-[calc(var(--size-2xs)*1.2)] pt-[calc(var(--size-2xs)*0.9)] light:border-neutral-5 dark:border-neutral-1 border-solid border-2 rounded-(--size-m) transition-colors ease-custom duration-300">
